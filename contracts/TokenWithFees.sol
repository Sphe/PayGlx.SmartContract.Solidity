...
// Note that what you think of as 1 GlobCoin token is internally represented
...
contract TokenWithFees is ModularPausableToken, HasRegistry {
    ...
    */
    ...
    function changeStakingFees(
        ...
        require(_transferFeeNumerator < _transferFeeDenominator, "transferFeeNumerator < transferFeeDenominator");
        require(_mintFeeNumerator < _mintFeeDenominator, "mintFeeNumerator < mintFeeDenominator");
        require(_burnFeeNumerator < _burnFeeDenominator, "burnFeeNumerator < burnFeeDenominator");
