...
contract OwnableDelegate is StorageState {
   ...
   */
    modifier onlyOwner() {
        require(msg.sender == OwnableLib.getOwner(_storage), "not owner");
        _;
    }
   ...
   */
    function transferOwnership(address newOwner) public onlyOwner {
        require(newOwner != address(0), "new owner can't be current adress");
        emit OwnershipTransferred(OwnableLib.getOwner(_storage), newOwner);
