...
contract CompliantToken is ModularPausableToken, HasRegistry {
    // In order to deposit USD and receive newly minted GlobCoin, or to burn GlobCoin to
    ...
    // Redeeming ("burning") GlobCoin tokens for USD requires a separate flag since
    ...
    // GlobCoin. This can be used to prevent the use of GlobCoin by bad actors in
